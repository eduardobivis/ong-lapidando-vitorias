...
<div class='form-group row'>
    ...
    <div class="col">
        {!! Form::text('data', $registro->dataFormatado, ['placeholder'=>'Data', 'class' => 'form-control data', 'autocomplete' => 'off']) !!}
    </div>
    <div class="col">
        {!! Form::text('horario', $registro->horarioFormatado, ['placeholder'=>'Horário', 'class' => 'form-control horario', 'autocomplete' => 'off']) !!}
    </div>
</div>
<div class='form-group row'>
    <div class="col">
