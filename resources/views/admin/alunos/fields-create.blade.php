...
<div class='form-group row'>
    ...
    <div class="col-md-2">
        {!! Form::select('situacao_id', $situacaoOptions, 1, ['class' => 'form-control', 'placeholder' => 'Situação']) !!}        
    </div>
</div>
<div class='form-group row'>
    <div class="col">
...
<div class="col">
    ...
    <div class="col-md-3">
        {!! Form::select('cidade_id', $cidadeOptions, 14, ['class' => 'form-control', 'placeholder' => 'Cidade']) !!}        
    </div>
    <div class="col-md-2">
